  ...
  "targets": [
    {
      ...
      "sources": [
        ...
        "native-src/main.cpp",
        "native-src/sync_root_watcher_refactor/FolderWatcher/FolderWatcher.cpp",
        "native-src/placeholders_interface/Planceholders.cpp"
      ],
      "include_dirs": [
        "include/sync_root_watcher",
        "include/sync_root_watcher_refactor",
        "include/placeholders_interface",
        "include/sync_root_interface",
        "include/virtual_drive",
        "include",
        "include/sync_root_watcher_refactor/FolderEvents",
        "include/sync_root_watcher_refactor/Callbacks",
        "include/sync_root_watcher_refactor/EventDetector",
        "include/sync_root_interface/callbacks",
        "include/sync_root_watcher_refactor/FolderWatcher"
      ],
      "libraries": [
        "-lCldApi.lib",
        "-lPropsys.lib"
